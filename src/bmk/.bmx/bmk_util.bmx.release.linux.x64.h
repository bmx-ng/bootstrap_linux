#ifndef BMK_BMK_UTIL_BMX_RELEASE_LINUX_X64_H
#define BMK_BMK_UTIL_BMX_RELEASE_LINUX_X64_H
...
void _m_bmk_util_MergeApp(BBSTRING bbt_fromFile,BBSTRING bbt_toFile);
