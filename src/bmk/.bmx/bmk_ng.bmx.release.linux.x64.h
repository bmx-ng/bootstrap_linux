#ifndef BMK_BMK_NG_BMX_RELEASE_LINUX_X64_H
#define BMK_BMK_NG_BMX_RELEASE_LINUX_X64_H
...
typedef void (*_m_bmk_ng_TBMKGlobals_Add_SS_m)(struct _m_bmk_ng_TBMKGlobals_obj*,BBSTRING,BBSTRING);
void __m_bmk_ng_TBMKGlobals_Add_SS(struct _m_bmk_ng_TBMKGlobals_obj*,BBSTRING,BBSTRING);
...
struct BBClass__m_bmk_ng_TBMKGlobals {
	...
	_m_bmk_ng_TBMKGlobals_Add_SS_m m_Add_SS;
