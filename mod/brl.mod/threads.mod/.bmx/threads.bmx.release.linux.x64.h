#ifndef BRL_THREADS_THREADS_BMX_RELEASE_LINUX_X64_H
#define BRL_THREADS_THREADS_BMX_RELEASE_LINUX_X64_H
...
struct brl_threads_TCancellationTokenSource_obj;
struct brl_threads_TCancellationToken_obj;
struct brl_threads_TCancellationException_obj;
...
typedef BBINT (*brl_threads_TCancellationTokenSource_IsClosed_m)(struct brl_threads_TCancellationTokenSource_obj*);
BBINT _brl_threads_TCancellationTokenSource_IsClosed(struct brl_threads_TCancellationTokenSource_obj*);
typedef BBINT (*brl_threads_TCancellationTokenSource_IsCancellationRequested_m)(struct brl_threads_TCancellationTokenSource_obj*);
BBINT _brl_threads_TCancellationTokenSource_IsCancellationRequested(struct brl_threads_TCancellationTokenSource_obj*);
struct BBClass_brl_threads_TCancellationTokenSource {
	BBClass*  super;
	void      (*free)( BBObject *o );
	BBDebugScope* debug_scope;
	unsigned int instance_size;
	...
	unsigned int obj_size;
	unsigned int instance_count;
	brl_threads_TCancellationTokenSource_IsClosed_m m_IsClosed;
	brl_threads_TCancellationTokenSource_IsCancellationRequested_m m_IsCancellationRequested;
};

struct brl_threads_TCancellationTokenSource_obj {
	struct BBClass_brl_threads_TCancellationTokenSource* clas;
};
extern struct BBClass_brl_threads_TCancellationTokenSource brl_threads_TCancellationTokenSource;
void _brl_threads_TCancellationToken_New(struct brl_threads_TCancellationToken_obj* o);
typedef BBINT (*brl_threads_TCancellationToken_CanBeCancelled_m)(struct brl_threads_TCancellationToken_obj*);
BBINT _brl_threads_TCancellationToken_CanBeCancelled(struct brl_threads_TCancellationToken_obj*);
typedef BBINT (*brl_threads_TCancellationToken_IsCancellationRequested_m)(struct brl_threads_TCancellationToken_obj*);
BBINT _brl_threads_TCancellationToken_IsCancellationRequested(struct brl_threads_TCancellationToken_obj*);
typedef void (*brl_threads_TCancellationToken_ThrowIfCancellationRequested_m)(struct brl_threads_TCancellationToken_obj*);
void _brl_threads_TCancellationToken_ThrowIfCancellationRequested(struct brl_threads_TCancellationToken_obj*);
struct BBClass_brl_threads_TCancellationToken {
	BBClass*  super;
	void      (*free)( BBObject *o );
	BBDebugScope* debug_scope;
	unsigned int instance_size;
	...
	unsigned int obj_size;
	unsigned int instance_count;
	brl_threads_TCancellationToken_CanBeCancelled_m m_CanBeCancelled;
	brl_threads_TCancellationToken_IsCancellationRequested_m m_IsCancellationRequested;
	brl_threads_TCancellationToken_ThrowIfCancellationRequested_m m_ThrowIfCancellationRequested;
};

struct brl_threads_TCancellationToken_obj {
	struct BBClass_brl_threads_TCancellationToken* clas;
	struct brl_threads_TCancellationTokenSource_obj* _brl_threads_tcancellationtoken_source;
};
extern struct BBClass_brl_threads_TCancellationToken brl_threads_TCancellationToken;
void _brl_threads_TCancellationException_New(struct brl_threads_TCancellationException_obj* o);
struct BBClass_brl_threads_TCancellationException {
...
struct brl_threads_TCancellationException_obj {
	struct BBClass_brl_threads_TCancellationException* clas;
};
extern struct BBClass_brl_threads_TCancellationException brl_threads_TCancellationException;
