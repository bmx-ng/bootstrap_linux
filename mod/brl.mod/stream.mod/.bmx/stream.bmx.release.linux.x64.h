#ifndef BRL_STREAM_STREAM_BMX_RELEASE_LINUX_X64_H
#define BRL_STREAM_STREAM_BMX_RELEASE_LINUX_X64_H
...
typedef BBLONG (*brl_stream_TCStream_Pos_m)(struct brl_stream_TCStream_obj*);
BBLONG _brl_stream_TCStream_Pos(struct brl_stream_TCStream_obj*);
typedef BBLONG (*brl_stream_TCStream_Size_m)(struct brl_stream_TCStream_obj*);
BBLONG _brl_stream_TCStream_Size(struct brl_stream_TCStream_obj*);
...
struct BBClass_brl_stream_TCStream {
	...
	unsigned int instance_count;
	brl_stream_TIO_Eof_m m_Eof;
	brl_stream_TCStream_Pos_m m_Pos;
	brl_stream_TCStream_Size_m m_Size;
...
struct brl_stream_TCStream_obj {
	...
	BBLONG _brl_stream_tcstream__pos;
	BBLONG _brl_stream_tcstream__size;
	BBINT _brl_stream_tcstream__mode;
	BBBYTE* _brl_stream_tcstream__cstream;
};
