#ifndef BRL_SOCKET_SOCKET_BMX_RELEASE_LINUX_X64_H
#define BRL_SOCKET_SOCKET_BMX_RELEASE_LINUX_X64_H
...
extern BBINT ioctl(BBINT bbt_socket,BBINT bbt_opt,BBBYTE* bbt_buf);
